...
{
    cout_class = class_new(gensym("cout~"), (t_newmethod)cout_new,
                           (t_method)cout_free, sizeof(t_cout), 0, A_GIMME, 0);
...
{
    cin_class = class_new(gensym("c.in~"), (t_newmethod)cin_new,
                          (t_method)cin_free, sizeof(t_cin), 0, A_GIMME, 0);
